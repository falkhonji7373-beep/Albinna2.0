...
export async function generateMetadata({
  ...
  const description = isRTL
    ? 'شركة البناء: عقد واحد يشمل الهيكل الإنشائي وأنظمة MEP والتشطيبات. معتمدة ISO 9001:2015. 28 عامًا. +20 مشروعًا في عُمان.'
    : 'Al Binaa delivers civil structure, MEP, and interior finishing under one management contract. ISO 9001:2015 certified. 28 years. 20+ projects across Oman.';
